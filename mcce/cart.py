...
class CARTMethod(Method):
    ...
    def fit(self, X_df, y_df):
        ...
        self.leaves_y_dict = leaves_y_df.groupby('leaves').apply(lambda x: x.to_numpy()[:, -1], include_groups=False).to_dict()
    ...
    def predict(self, X_test_df):
        ...
        leaves_pred_index_dict = leaves_pred_index_df.groupby('leaves_pred').apply(lambda x: x.to_numpy()[:, -1], include_groups=False).to_dict()
